...
\small\setlength{\tabcolsep}{0.2em}
\begin{tikzpicture}
\node[bn variable] at (1.25, 2.5) (C) {Cloudy};
\node[bn table,above=0.2em of C] {\footnotesize
\begin{tabular}{ c }
\textbf{P(C)} \\
\hline
.50
...
\node[bn variable] at (0, 1.25) (S) {Sprinkler};
\node[bn table,left=0.2em of S] {\footnotesize
\begin{tabular}{ c c }
\textbf{C} & \textbf{P(S|C)} \\
\hline
T & .10 \\
...
\node[bn variable] at (2.5, 1.25) (R) {Rain};
\node[bn table,right=0.2em of R] {\footnotesize
\begin{tabular}{ c c }
\textbf{C} & \textbf{P(R|C)} \\
\hline
T & .80 \\
...
\node[bn variable] at (1.25, 0) (W) {Wet Grass};
\node[bn table,below=0.2em of W] {\footnotesize
\begin{tabular}{ c c c }
