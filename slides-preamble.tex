...
\newcommand{\wumpusagent}[3]{%
\only<#1>{\node at (#2\wumpusgridsize+0.5\wumpusgridsize,#3\wumpusgridsize+0.25\wumpusgridsize) {\fbox{A}};}
}
...
\only<#1>{\node[draw,cloud,inner sep=0pt] at (#2\wumpusgridsize+0.75\wumpusgridsize,#3\wumpusgridsize+0.75\wumpusgridsize) {\footnotesize #4};}
}
