...
\begin{frame}{Probability Theory}
	...
	\begin{tabular}{@{}l@{\hspace{.5em}}l@{}}
		\pause
		\keyword{Random Variable} & An interesting part of the world \\
		                      & e.g. $\textit{Sky}$ or $\textit{Temp}$ \\[.5em]
		\pause
		\keyword{Domain}          & Possible values of a random variable \\
		                      & e.g. $\textit{domain}(\textit{Temp})=\langle\textit{warm}, \textit{cold}, \ldots\rangle$ \\[.5em]
		\pause
		\keyword{Proposition}     & A statement, like propositional logic \\
		                      & e.g. $\textit{Sky}\!=\!\textit{sunny} \land \textit{Temp}\!=\!\textit{warm}$ \\[.5em]
		\pause
		\keyword{Probability}     & The degree of belief in a proposition \\
