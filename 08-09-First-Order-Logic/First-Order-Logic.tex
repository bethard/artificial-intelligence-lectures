...
& \{\}
\pause\\
\left[\textit{Rich}(a), \textit{Wants}(a, b), \textit{Sells}(z, b)\right]
& \{u=a, v=b\}
\pause\\
\left[\textit{Wants}(a, b), \textit{Sells}(z, b)\right]
& \{u=a=\textit{Bill}, v=b\}
\pause\\
\left[\textit{Hot}(a), \textit{IceCream}(b), \textit{Sells}(z, b)\right]
& \{u=a=\textit{Bill}=x, v=b=y\}
\pause\\
\left[\textit{IceCream}(b), \textit{Sells}(z, b)\right]
& \{u=a=\textit{Bill}=x, v=b=y\}
\pause\\
\left[\textit{Sells}(z, b)\right]
& \{u=a=\textit{Bill}=x, v=b=y=\textit{Mint}\}
\pause\\
\left[\textit{IceCream}(z)\right]
& \{u=a=\textit{Bill}=x, v=b=y=\textit{Mint}, z=\textit{Brusters}\}
\pause\\
\left[\right]
& \{u=a=\textit{Bill}=x, v=b=y=\textit{Mint}, z=\textit{Brusters}\}
\end{array}
