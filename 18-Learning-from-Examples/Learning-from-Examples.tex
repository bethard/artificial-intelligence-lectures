...
\addplot[no marks] {0.6 + 1.2*x} node[left,near end] {$h_{\theta_2}$};
}
\end{axis}
\end{tikzpicture}
\end{column}
...
\begin{itemize}
\item None?
\visible<2->{$\theta_1$ (1 vs. 5)}
\item $L_1$ with $\lambda=1$?
\visible<2->{$\theta_1$ (7 vs. 8)}
\item $L_2$ with $\lambda=1$?
\visible<2->{$\theta_2$ (15 vs. 14)}
\end{itemize}
\visible<2->{
