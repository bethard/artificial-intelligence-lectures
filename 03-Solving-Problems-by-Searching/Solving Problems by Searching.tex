...
for tree={circle,draw}
[A,expanded on={<2->}
  [B,expanded on={<3->},invisible on=<10->
    [D,expanded on={<4->},invisible on=<7->
      [H,expanded on={<5->},invisible on=<6->]
      [I,expanded on={<6->},invisible on=<7->]
    ]
    [E,expanded on=<7->,invisible on=<10->
      [J,expanded on=<8->,invisible on=<9->]
      [K,expanded on=<9->,invisible on=<10->]
    ]
  ]
  [C,never expanded
    [F,never expanded
