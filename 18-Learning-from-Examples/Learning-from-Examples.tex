...
\tikzset{
  nn io/.style={draw,minimum size=2em},
  nn unit/.style={draw,ellipse split,minimum size=4em},
...
for tree={draw,minimum height=3.25em},
baseline
...
\node[nn io] (i1) at (0, 2) {\only<2-4>{1}\only<5->{0}};
\node[nn io] (i2) at (0, -2) {\only<2->{1}};
\node[nn unit] (and) at (2, 0) {\only<3-4>{2.0}\only<6->{1.0}\nodepart{lower}$ > \!\! 1.5 $};
\node[nn io] (o) at (5, 0) {\only<4>{1}\only<7->{0}};
\path[nn edge] (i1) -- node[midway,left] {1.0} (and);
\path[nn edge] (i2) -- node[midway,left] {1.0} (and);
\path[nn edge] (and) -- (o);
\end{tikzpicture}
\end{center}
\end{frame}
...
\node[nn io] (i1) at (0, 2) {\only<2->{1}};
\node[nn io] (i2) at (0, -2) {\only<2->{1}};
\node[nn unit] (u1) at (3, 2) {\only<3->{0.5}\nodepart{lower} $> \!\! 1.5$};
\node[nn unit] (u2) at (3, -2) {\only<4->{1.5}\nodepart{lower} $> \!\! 0.5$};
\node[nn unit] (u3) at (6, 0) {\only<5->{1.0}\nodepart{lower} $> \!\! 0.5$};
\node[nn io] (o) at (9, 0) {\only<6->{1.0}};
\path[nn edge] (i1) -- node[near end,above] {-0.5} (u1);
\path[nn edge] (i1) -- node[very near end,left] {0.5} (u2);
\path[nn edge] (i2) -- node[very near end,left] {1.0} (u1);
\path[nn edge] (i2) -- node[near end,below] {1.0} (u2);
\path[nn edge] (u1) -- node[near end,above=0.2em] {-0.5} (u3);
\path[nn edge] (u2) -- node[near end,below=0.2em] {1.0} (u3);
\path[nn edge] (u3) -- (o);
\end{tikzpicture}
\end{center}
\end{frame}
...
\node[nn io] (i1) at (0, 3) {1};
\node[nn io] (i2) at (0, 0) {0};
\node[nn io] (i3) at (0, -3) {1};
\node[nn unit] (u1) at (3, 1.5) {\only<2->{0.0}\nodepart{lower}$>$0.5};
\node[nn unit] (u2) at (3, -1.5) {\only<2->{1.5}\nodepart{lower}$>$1.0};
\node[nn unit] (u3) at (6, 1.5) {\only<2->{1.5}\nodepart{lower}$>$0.0};
\node[nn unit] (u4) at (6, -1.5) {\only<2->{-1.0}\nodepart{lower}$>$-0.5};
\node[nn unit] (u5) at (8.5, 0) {\only<2->{-0.5}\nodepart{lower}$>$0.5};
\node[nn io] (o) at (10.5, 0) {\only<2->{0.0}};
\path[nn edge] (i1) -- node[near end,above] {\small 0.5} (u1);
\path[nn edge] (i1) -- node[very near end,right] {\small 0.5} (u2);
\path[nn edge] (i2) -- node[near end,above] {\small 1.0} (u1);
\path[nn edge] (i2) -- node[near end,below] {\small 0.5} (u2);
\path[nn edge] (i3) -- node[very near end,right] {\small -0.5} (u1);
\path[nn edge] (i3) -- node[near end,below] {\small 1.0} (u2);
\path[nn edge] (u1) -- node[near end, above] {\small 1.0} (u3);
\path[nn edge] (u1) -- node[near end, right] {\small 0.5} (u4);
\path[nn edge] (u2) -- node[near end, right] {\small 1.5} (u3);
\path[nn edge] (u2) -- node[near end, below] {\small -1.0} (u4);
\path[nn edge] (u3) -- node[near end, above] {\small -0.5} (u5);
\path[nn edge] (u4) -- node[near end, below] {\small 1.0} (u5);
\path[nn edge] (u5) -- (o);
\end{tikzpicture}
\end{center}
\end{frame}
