...
\\
\textit{Eats}(x, y) \limpl \textit{Edible}(y)
...
\small
	\begin{tabular}{p{0.97\textwidth}}
		...
		\tab$\forall x \forall y \forall z\ \textit{Rich}(x) \land \textit{Wants}(x, y) \land \textit{Sells}(z, y) \limpl \textit{Buys}(x, y)$ \\
		...
		\tab$\forall y\ \textit{IceCream}(y) \limpl \textit{Sells}(\textit{HaagenDazs}, y)$ \\
...
\visible<3->{
\textit{IceCream}(\textit{Mint}) \\
\forall y\ \textit{IceCream}(y) \limpl \textit{Sells}(\textit{HaagenDazs}, y) \\
\theta = \{ y = \textit{Mint} \} \\
\hline}
\visible<4->{
...
\forall x \forall y \forall z\ \textit{Rich}(x) \land \textit{Wants}(x, y) \land \textit{Sells}(z, y) \limpl \textit{Buys}(x, y) \\
\theta = \{ x = \textit{Bill}, y = \textit{Mint}, z = \textit{HaagenDazs} \} \\
\hline}
\visible<6->{
...
\lefteqn{\forall x \forall y \forall z\ \textit{Rich}(x) \land \textit{Wants}(x, y) \land \textit{Sells}(z, y) \limpl \textit{Buys}(x, y)} \\
\lefteqn{\forall x \forall y\ \textit{Hot}(x) \land \textit{IceCream}(y) \limpl \textit{Wants}(x, y)} \\
\lefteqn{\forall y\ \textit{IceCream}(y) \limpl \textit{Sells}(\textit{HaagenDazs}, y)} \\
\textit{IceCream}(\textit{Mint})
& \textit{Rich}(\textit{Bill})
& \textit{Hot}(\textit{Bill})
\end{array}
...
\tab$
\begin{array}{ @{} l @{\hspace{4em}} l @{\hspace{4em}} l @{} }
\lefteqn{\forall x \forall y \forall z\ \lnot\textit{Rich}(x) \lor \lnot\textit{Wants}(x, y) \lor \lnot\textit{Sells}(z, y) \lor \textit{Buys}(x, y)} \\
\lefteqn{\forall x \forall y\ \lnot\textit{Hot}(x) \lor \lnot\textit{IceCream}(y) \lor \textit{Wants}(x, y)} \\
\lefteqn{\forall y\ \lnot\textit{IceCream}(y) \lor \textit{Sells}(\textit{HaagenDazs}, y)} \\
\textit{IceCream}(\textit{Mint})
& \textit{Rich}(\textit{Bill})
& \textit{Hot}(\textit{Bill})
\end{array}
$
\\[0.5em]
Prove $\exists x \exists y\ \textit{Buys}(x, y)$:\\
\pause
\tab$
\begin{array}{ @{} l @{} }
\forall x \forall y\ \lnot\textit{Buys}(x, y) \\
\pause
\forall x \forall y \forall z\ \lnot\textit{Rich}(x) \lor \lnot\textit{Wants}(x, y) \lor \lnot\textit{Sells}(z, y) \lor \textit{Buys}(x, y) \\
\pause
\theta = \{ \} \\
\hline
\pause
\forall x \forall y \forall z\ \lnot\textit{Rich}(x) \lor \lnot\textit{Wants}(x, y) \lor \lnot\textit{Sells}(z, y)\\
\pause
\textit{Rich}(\textit{Bill}) \\
\pause
\theta = \{ x = \textit{Bill} \} \\
\hline
\pause
\forall y \forall z\ \lnot\textit{Wants}(\textit{Bill}, y) \lor \lnot\textit{Sells}(z, y) \\
\pause
...
\hline
\pause
\forall y \forall z\ \lnot\textit{Hot}(\textit{Bill}) \lor \lnot\textit{IceCream}(y) \lor \lnot\textit{Sells}(z, y) \\
\end{array}
$
\end{frame}
...
\forall y \forall z\ \lnot\textit{Hot}(\textit{Bill}) \lor \lnot\textit{IceCream}(y) \lor \lnot\textit{Sells}(z, y) \\
\pause
\forall y\ \lnot\textit{IceCream}(y) \lor \textit{Sells}(\textit{HaagenDazs}, y) \\
\pause
\theta = \{ z = \textit{HaagenDazs} \} \\
\hline
\pause
\forall y\ \lnot\textit{Hot}(\textit{Bill}) \lor \lnot\textit{IceCream}(y) \\
\pause
\textit{IceCream}(\textit{Mint}) \\
\pause
\theta = \{ y = \textit{Mint} \} \\
