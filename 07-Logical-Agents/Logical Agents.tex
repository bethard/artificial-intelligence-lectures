...
\begin{tabular}{ @{} | @{} l @{} | @{} l @{} | @{} l @{} | @{} }
\hhline{--~}
\wumpcell{}{}{\only<3->{\Huge ?}} &
\wumpcell{}{}{\only<3->{\Huge ?}} &
\multicolumn{1}{c}{} \\
\hline
\wumpcell{}{}{\only<1>{\fbox{A}}} &
\wumpcell{\only<2->{B}}{}{\only<2->{\fbox{A}}} &
\wumpcell{}{}{\only<3->{\Huge ?}} \\
\hline
\end{tabular}
\end{column}
...
\pause\item[Sound?] \pause Yes, directly implements entailment definition
\pause\item[Complete?] \pause Yes, explores all possibilities
\pause\item[Time?] \pause Given $n$ symbols, takes $O(2^n)$
\end{description}
\end{block}
\end{frame}
