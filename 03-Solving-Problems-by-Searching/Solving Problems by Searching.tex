...
for tree={grow'=east}
[Birmingham
  [Atlanta,invisible on={<-2>}
    [Birmingham,invisible on={<-3>}]
    [Chattanooga,invisible on={<-3>}]
    [Augusta,invisible on={<-3>}]
    [\ldots]
  ]
  [Montgomery,invisible on={<-2>}
    [Birmingham]
    [Atlanta]
    [Mobile]
    [\ldots]
  ]
  [Tuscaloosa,invisible on={<-2>}
    [Birmingham]
    [Meridian]
    [Starkville]
    [\ldots]
...
\begin{forest}
for tree={circle,draw}
[A,invisible on={<{3,8,17}>},filled on={<{2,5-7,10-}>}
  [B,invisible on={<{-4,7-9,14-}>},filled on={<{6,11-13}>}
    [D,invisible on={<{-10,13}>},filled on={<{12}>}
      [H,invisible]
      [I,invisible]
    ]
    [E,invisible on={<{-10}>},filled on={<{13}>}
      [J,invisible]
      [K,invisible]
    ]
  ]
  [C,invisible on={<{1-4,8-9}>},filled on={<{7,14-16}>}
    [F,invisible on={<{-13,16-}>},filled on={<15>}
      [L,invisible]
      [M,invisible]
    ]
    [G,invisible on={<{-13,17-}>},filled on={<16>}
      [N,invisible]
      [O,invisible]
    ]
  ]
