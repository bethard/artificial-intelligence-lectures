...
for tree={circle,draw},
[A,expanded on={<2->}
  [B,edge weight={2},expanded on={<4->}
    [D,edge weight={1},expanded on={<6->}
      [H,edge weight={2}]
      [I,edge weight={3}]
    ]
    [E,edge weight={1},never expanded
      [J,edge weight={3}]
      [K,edge weight={2}]
    ]
  ]
  [C,edge weight={1},expanded on={<3->}
    [F,edge weight={3},never expanded
      [L,edge weight={1}]
      [M,edge weight={1}]
    ]
    [G,edge weight={2},expanded on={<5->}
      [N,edge weight={1}]
      [O,edge weight={3}]
    ]
  ]
