...
\subsection{Factors and Dynamic Programming}
...
a & j & \rightarrow & 0.90 \\
a & \lnot j & \rightarrow & 0.05 \\
\lnot a & j & \rightarrow & 0.10 \\
\lnot a & \lnot j & \rightarrow & 0.95
\end{array}\right)
& \times
& \left(\begin{array}{ r r c l }
a & m & \rightarrow & 0.70 \\
a & \lnot m & \rightarrow & 0.01 \\
\lnot a & m & \rightarrow & 0.30 \\
\lnot a & \lnot m & \rightarrow & 0.99
\end{array}\right)
& = 
& \uncover<3->{
\left(\begin{array}{ r r r c l }
a & j & m & \rightarrow & \uncover<4->{0.63} \\
a & j & \lnot m & \rightarrow & \uncover<5->{0.09} \\
a & \lnot j & m & \rightarrow & \uncover<6->{0.035} \\
a & \lnot j & \lnot m & \rightarrow & \uncover<7->{0.0005} \\
\lnot a & j & m & \rightarrow & \uncover<8->{0.07} \\
\lnot a & j & \lnot m & \rightarrow & \uncover<8->{0.001} \\
\lnot a & \lnot j & m & \rightarrow & \uncover<8->{0.285} \\
\lnot a & \lnot j & \lnot m & \rightarrow & \uncover<8->{0.9405} \\
\end{array}\right)
}
\end{array}$
\end{center}
