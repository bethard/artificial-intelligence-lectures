...
\begin{tikzpicture}[
  ...
  clause/.style={draw}]
\node[symbol,red edge on={2-4},pink fill on={3-4}] at (0, 0) (A) {$A$};
\node[symbol,red edge on={2-7},pink fill on={5-7}] at (5, 0) (B) {$B$};
\node[symbol,red edge on={7-10,16-17},pink fill on={8-10,17}] at (2.5, 2) (L) {$L$};
\node[symbol,red edge on={10-13},pink fill on={11-13}] at (5, 4) (M) {$M$};
\node[symbol,red edge on={13-16},pink fill on={14-16}] at (0, 4) (P) {$P$};
\node[symbol,red edge on={16-,18-},pink fill on={18-}] at (2.5, 6) (Q) {$Q$};
